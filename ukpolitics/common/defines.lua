...
NDiplomacy = {
	...
	DEMESNE_MAX_SIZE_STEWARDSHIP_MULT = 0.0,	-- Extra Max Demesne Size from ruler and spouse stewardship
	...
	VASSAL_LIMIT_DUKE_MULT = 25.0, 				-- Extra Vassal Limit from the ruler's rank
	VASSAL_LIMIT_KING_MULT = 200.0, 				-- Extra Vassal Limit from the ruler's rank
	VASSAL_LIMIT_EMPEROR_MULT = 650.0, 			-- Extra Vassal Limit from the ruler's rank
	VASSAL_LIMIT_GREAT_DUKE_BONUS = 0.0, 		-- Extra Vassal Limit for Dukes with more than one Duchy
	VASSAL_LIMIT_DIPLOMACY_MULT = 0.0,			-- Extra Vassal Limit from ruler and spouse diplomacy
